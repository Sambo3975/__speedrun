...
return {
	[0] = {
		...
		"rn",{"x",">=",-183552+16},
		"jrn",{18},
		"ln",{"ml"},  -- collect Heart #4
		"d",{79},     -- need to wait a few extra frames to avoid Pitchin' Chuck's baseball
		"arn",{"md"}, -- big spinjump to get out and land on the pipes to the right
		"drn",{"tg"},
		"jrn",{4},
		"rn",{"tg"},
		"jrn",{"md"},
